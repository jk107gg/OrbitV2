        ...
        >
          <div className="relative group">
            ...
            <div className="absolute -inset-[1px] rounded-2xl overflow-hidden">
              ...
              {/* Corner glows */}
              {[
                { className: "absolute top-0 left-0 h-[5px] w-[5px] rounded-full bg-white/40 blur-[1px]", delay: 0, duration: 2 },
                { className: "absolute top-0 right-0 h-[8px] w-[8px] rounded-full bg-white/60 blur-[2px]", delay: 0.5, duration: 2.4 },
                { className: "absolute bottom-0 right-0 h-[8px] w-[8px] rounded-full bg-white/60 blur-[2px]", delay: 1, duration: 2.2 },
                { className: "absolute bottom-0 left-0 h-[5px] w-[5px] rounded-full bg-white/40 blur-[1px]", delay: 1.5, duration: 2.3 },
              ].map((glow, i) => (
                <motion.div
                  key={i}
                  className={glow.className}
                  animate={{ opacity: [0.2, 0.4, 0.2] }}
                  transition={{ duration: glow.duration, repeat: Infinity, repeatType: "mirror", delay: glow.delay }}
                />
              ))}
            </div>
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70">O</span>
              ...
              >
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <a href="/forgot-password" className="text-xs text-white/60 hover:text-white transition-colors duration-200">
                    Forgot password?
                  </a>
                </div>
